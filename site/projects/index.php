...
?><main class="main main-projects main--gray">
<div class="container">
	 <?$APPLICATION->IncludeComponent(
	"bitrix:breadcrumb",
	"cm_breadcrumb",
	Array(
		"COMPONENT_TEMPLATE" => "cm_breadcrumb",
		"PATH" => "",
		"SITE_ID" => "s1",
		"START_FROM" => "0"
	)
	...
	Array(
		...
		"CACHE_TYPE" => "A",
		"CHECK_DATES" => "Y",
		"COMPONENT_TEMPLATE" => "cm_news-projects",
		...
		"DETAIL_PROPERTY_CODE" => array(0=>"SUB_TITLE",1=>"",),
		...
		"LIST_PROPERTY_CODE" => array(0=>"SUB_TITLE",1=>"",),
		"MESSAGE_404" => "",
		"META_DESCRIPTION" => "-",
		"META_KEYWORDS" => "-",
		"NEWS_COUNT" => "3",

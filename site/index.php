  ...
  <section class="main-projects section">
    <div class="container">
      ...
      <div class="projects-slider">
        <aticle class="project slide-type02 projects-slider__project">
          <div class="slide-type02__aside">
            <figure class="slide-type02__logo">
              <img src="<?=SITE_TEMPLATE_PATH?>/pics/projects/project_001.png" alt="">
            </figure>
          ...
          <div class="slide-type02__bside">
            <span class="slide-type02__article">
              <h4 class="slide-type02__title">
                ООО «Виталюр»
                <p>
                  Проектирование и прокладка электросети
                </p>
              </h4>
              <p>
                Разнообразный и богатый опыт начало повседневной работы по формированию позиции представляет собой интересный эксперимент проверки модели...
              </p>
            </span>
            <a href="" class="link-more slide-type02__link-more">
              Подробнее
            </a>
          </div>
        </aticle>
        <ul class="dots projects-slider__dots">
          <li class="dots__dot dots__dot--gray active"></li>
          <li class="dots__dot dots__dot--gray"></li>
          <li class="dots__dot dots__dot--gray"></li>
          <li class="dots__dot dots__dot--gray"></li>
          <li class="dots__dot dots__dot--gray"></li>
        </ul>
